...
bot_token = "5870985444:AAF8YdfP6m5F0-X_Vxz3O-2AlcWVHMSM884"
...
def start(update : Update , context : CallbackContext):
    ...
    if user in auth:
        ...
        if user in username:
            ...
            update.message.reply_text("شما به عنوان نماینده ثبت نشده اید")
...
def button(update: Update, context: CallbackContext) -> None:
    ...
    if user in auth:
        if query.data == "order":
            ...
            query.message.edit_text("این ربات توسط تیم @bvbloxic برنامه نویسی شده است.")
